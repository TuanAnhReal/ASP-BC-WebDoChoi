...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="MyStyle/Default.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="fixed-bg-wrapper">
        <div class="glass-frame">
            <%--banner--%>
            <div id="mainCarousel" class="carousel slide carousel-fade shadow-sm mb-0 py-4" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <asp:Repeater ID="rptBanner" runat="server">
                        <ItemTemplate>
                            <div class='carousel-item <%# Container.ItemIndex == 0 ? "active" : "" %>'>
                                <a href='<%# Eval("LienKet") %>'>
                                    <img src='<%# "Images/Banners/" + Eval("HinhAnh") %>' class="d-block w-100" alt='<%# Eval("TieuDe") %>'>
                                </a>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                <h6 class="fw-bold text-danger">Danh mục</h6>
                                <div class="mb-3" style="max-height: 200px; overflow-y: auto;">
                                    <asp:CheckBoxList ID="cblNhom" runat="server" CssClass="form-check"
                                        DataTextField="TenNhom" DataValueField="MaNhom">
                                    </asp:CheckBoxList>
                                </div>
                                <hr />
                    ...
                    <div class="col-md-9">
                        ...
                        <asp:ListView ID="lvSanPham" runat="server">
                            ...
                            <ItemTemplate>
                                <div class="col">
                                    <div class="card h-100 shadow-sm border-0 product-card product-related-card">
