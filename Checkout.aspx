    ...
    <div class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-md-6 bg-light p-4 rounded">
                ...
                <div class="mb-4">
                    <h5 class="fw-bold border-bottom pb-2">Hình thức thanh toán</h5>
                    <asp:RadioButtonList ID="rblHinhThucTT" runat="server" CssClass="form-check" RepeatLayout="Flow">
                        <%--thânh toán khi nhận hàng (COD)--%>
                        <asp:ListItem Value="COD" Selected="True" class="me-2"> Thanh toán khi nhận hàng
                        </asp:ListItem>
                    </asp:RadioButtonList>
                </div>
