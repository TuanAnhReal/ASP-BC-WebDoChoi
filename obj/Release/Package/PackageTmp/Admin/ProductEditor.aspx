<%@ Page Title="Chỉnh sửa sản phẩm" ValidateRequest="false" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ProductEditor.aspx.cs" Inherits="WebDoChoi.Admin.ProductEditor" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <asp:DropDownList ID="ddlNhomSP" runat="server" CssClass="form-select"></asp:DropDownList>
                                <asp:RequiredFieldValidator ID="rfvNhom" runat="server" ControlToValidate="ddlNhomSP" 
                                    InitialValue="0" ErrorMessage="Vui lòng chọn nhóm" CssClass="text-danger small" Display="Dynamic" />
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <asp:TextBox ID="txtMoTaChiTiet" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="5"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    // 2. Thay thế TextBox thường thành CKEditor
    // Quan trọng: Phải dùng ClientID vì ASP.NET có thể đổi ID khi render
    CKEDITOR.replace('<%= txtMoTaChiTiet.ClientID %>');
</script>
</asp:Content>
